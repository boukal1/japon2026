# Voyage Chine × Japon — 16 septembre › 2 octobre 2026

> **Mémoire de voyage complète.** Ce fichier est la source de vérité (décisions, raisonnements, réservations, contraintes). Le fichier `voyage-japon-2026.html` en est la représentation lisible/jolie.
>
...
### Ancres de vol (fixes — tout se cale dessus)

| Segment | Vol(s) | Départ | Arrivée |
|---|---|---|---|
| Genève → Zurich → Shanghai | LX2809 + LX188 | 16 sept 11:00 (GVA) | **17 sept 07:15 (PVG)** |
| Shanghai → Osaka | NH974 | **18 sept 11:35 (PVG)** | 18 sept 14:55 (KIX) |
| Tokyo → Vienne → Genève | OS8564 + OS151 | **1 oct 22:45 (HND)** | 2 oct 08:50 (GVA) |

### Contexte décisif — Silver Week 2026
...
- **Tatouage** (grande pièce sur la jambe) → bains communs exclus. Partout : **ryokan à rotenburo privatif** + établissements tattoo-friendly (dont **bain de sable de Beppu**, habillé du yukata).
- **Conduite** : permis suisses + **traduction JAF en japonais** (déjà arrangée). Location de voiture au Japon.
- **Visa** : ressortissants suisses = **exemption de visa 30 jours en Chine** (confirmée jusqu'à fin 2026).
- **Déjà visité, à ne PAS refaire** : Hiroshima, Nara, Kyoto (**sauf** Musée Nintendo à Uji), Hakone, Himeji.

### Fil directeur (préférences)

- **Authentique / participatif** plutôt que passif ou kitsch (on fait, on ne subit pas).
- **Gastronomie hyper-locale** : chaque étape a son plat ancré dans sa géographie.
- **La route panoramique est une attraction en soi** (Yamanami Highway, Milk Road d'Aso).
- **Format boucle (« boucle ») privilégié** pour le road-trip.
- **Arbitrages assumés explicitement** (cf. sacrifice du jour tampon ci-dessous).

---

## 2. Structure verrouillée
...
## 3. Shanghai express — 24 h (17–18 sept)

Arrivée PVG le 17 à 07:15, départ vers ~08:00 le 18 : ~24 h utiles avec jet lag.
...
- Milieu de gamme dans le périmètre East Nanjing Road.

### Programme

| Moment | Activité |
|---|---|
| 07:15 | Arrivée PVG → transfert privé → dépose bagages (check-in pas encore prêt) |
| Matin | Yu Garden + vieille ville + maison de thé Huxinting · **xiaolongbao chez Nanxiang** |
| Midi | Le Bund (Waitan) — architecture coloniale + skyline Pudong |
| Après-midi | Concession française : Xintiandi / Tianzifang / Wukang Road (cafés, shopping) |
| Fin d'ap. | Pudong — **Shanghai Tower** (pont d'observation) au coucher du soleil |
| Soir | Bund illuminé + dîner shanghaïen (option croisière Huangpu) |
| 18 sept ~08:00 | Transfert privé → PVG (vol NH974 11:35, arriver ~2h30 avant) |

**Food :** xiaolongbao (Nanxiang), street food shanghaïenne.
...
### Baseball ⚾ — RÉSERVÉ (ven 18 sept, 18:00, Koshien)

**Hanshin – Hiroshima, Koshien (Nishinomiya), vendredi 18 septembre, 18:00.** ~20 km / ~40 min depuis Kansai Airport — transfert direct après l'atterrissage du vol Shanghai→Osaka (KIX 14:55). Les billets sont en main ; pas de fiche détaillée dans `reservations/` (rien d'autre à documenter que le billet lui-même).

> 🔒 **Décision figée le 6 septembre 2026 : un seul match de baseball sur tout le voyage, celui du 18.**
> Toutes les pistes de « second match éventuel » sont **abandonnées** et retirées du document :
> les matchs Pacific League du 27/28/29 à Tokyo (Seibu au Belluna Dome, Lotte au ZOZO Marine),
> le repli Farm League au GIANTS TOWN d'Inagi, le doublon Koshien du 19, et le calendrier NPB
> jour par jour qui servait à les évaluer. **Plus rien à réserver, plus rien à surveiller côté
> baseball.** Le détail de cette exploration reste consultable dans l'historique git (commits
> antérieurs au 6 sept) si le sujet devait être rouvert.

**Conséquence :** la soirée Dotonbori initialement prévue le 18 est reportée à un autre soir à Osaka, et les soirées du 27 au 29 à Tokyo sont entièrement libres.

### Musée Nintendo — RÉSERVÉ (ne pas annuler)

- Acheté le 1 juil 2026 (référence dans le dossier privé, non versionné).
- Visite : **2026-09-19 (sam) 14:00–14:30 JST**. Adulte ×1, 3 300 ¥.
- QR récupérable dès **14:00 la veille** sur `check.museum-tickets.nintendo.com/myticket`.
...
|---|---|---|---|---|
| J1 | 21 sept (lun) | Hakata → Yanagawa → Kumamoto | Arrivée Shinkansen + prise voiture · **donko-bune** (barque canaux) + **unagi** midi · Kumamoto : château + **basashi** dîner | Kumamoto |
| J2 | 22 sept (mar) | Kumamoto → Aso → Takachiho | **Milk Road** + point de vue **Daikanbō** (caldeira Aso) · déjeuner **akaushi** · gorge de Takachiho (barque optionnelle) · **kagura** 20h | Takachiho |
| J3 | 23 sept (mer) | Takachiho → Beppu | **Yamanami Highway** intégrale (la route = l'attraction) | Beppu (rotenburo privatif) |
...
Un jour de plus que l'Option A (USJ retiré, cf. section 4), sans Takachiho (temps réinvesti à Fukuoka), avec un détour Amakusa (Kuratake Shrine), une tournée de statues **One Piece** essentiellement sur le trajet, **1 seule nuit en ryokan à Yufuin** (rotenburo privatif, tattoo-friendly — pas Beppu même, ~30-40 min de route entre les deux), un **jour libre/flexible** juste après passé à Beppu (rando Mont Tsurumi, jigoku-mushi, bain de sable), et une **nuit à Mojiko/Kitakyushu** — pile à mi-chemin vers Tsunoshima Bridge — qui remplace l'ancien arrêt déjeuner par une étape avec nuit sur place (Mojiko Retro est plus beau illuminé le soir, et ça désengorge la journée retour). **Kurokawa Onsen a été retiré** pour libérer ces nuits.

```
FUKUOKA (1 nuit) → Uto → Kuratake Shrine (Amakusa) → Kumamoto (1 nuit)
→ Ozu → Mashiki → Mifune → Nishihara → Aso → Yamanami Highway → Yufuin (1 nuit, ryokan)
→ Beppu (jour libre) → Mojiko Retro (1 nuit) → Tsunoshima Bridge → HAKATA
```
...
- 23 sept (équinoxe) = plus gros jour de retour national — on reste dans le secteur **Yufuin/Beppu** (jour libre, checkout + rando + onsen), pas sur la route pour un long trajet ce jour-là.
...
**Conséquence sur le planning Tokyo :** le **30 sept** est désormais **ancré à midi sur Nihonbashi / gare de Tokyo** — c'est le seul verrou du séjour Tokyo (le baseball est réglé le 18 sept à Koshien, cf. section 4, et aucun second match n'est prévu). La matinée et l'après-midi du 30 s'organisent naturellement autour du quartier : Nihonbashi, Ginza à pied, Kappabashi/Asakusa en métro direct.
